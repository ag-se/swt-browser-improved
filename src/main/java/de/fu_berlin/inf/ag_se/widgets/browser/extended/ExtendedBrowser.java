 ...
 * {@link de.fu_berlin.inf.ag_se.widgets.browser.extended.extensions.IBrowserExtension}s to be automatically loaded when the requested
 * {@link java.net.URI} was loaded.
 * 
 * @author bkahlert
 * 
 */
