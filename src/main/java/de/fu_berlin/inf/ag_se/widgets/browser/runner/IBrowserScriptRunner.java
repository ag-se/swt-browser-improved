...
public interface IBrowserScriptRunner {
	...
	/**
	 * Injects the script addressed by the given {@link java.net.URI} and returns a
	 * {@link java.util.concurrent.Future} that blocks until the script is completely loaded.
	 * <p>
	 * In contrast to {@link #run(java.net.URI)} the reference (
	...
	/**
	 * Runs the script contained in the given {@link java.io.File} in the browser as
	...
	/**
	 * Runs the script contained in the given {@link java.net.URI} in the browser as soon
	 * as its content is loaded.
	 * <p>
	 * In contrast to {@link #inject(java.net.URI)} functionality made available through
	 * the script does not persist. To inject script libraries like jQuery
	 * {@link #inject(java.net.URI)} is recommended. <b>Exception: If the resource is
	...
	/**
	 * Runs the script <b>contained</b> in the given {@link java.io.File} in the browser
