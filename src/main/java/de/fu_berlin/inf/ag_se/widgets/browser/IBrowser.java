...
public interface IBrowser extends IBrowserScriptRunner, IWidget {
	 ...
	 * @param address
	 * @param timeout
	 *            after which the {@link de.fu_berlin.inf.ag_se.widgets.browser.IBrowser} stops loading
	...
	/**
	 * Sets if {@link de.fu_berlin.inf.ag_se.widgets.browser.IBrowser} may change its location by actions now invoked
	...
	/**
	 * This method is called from the-UI thread after the {@link de.fu_berlin.inf.ag_se.widgets.browser.IBrowser}
	 ...
	 * {@link de.fu_berlin.inf.ag_se.widgets.browser.IBrowser} to finish loading and thus running its script queue.
	 * 
	 * @return
	 * @throws Exception
	 */
	...
	/**
	 * Removed the given {@link de.fu_berlin.inf.ag_se.widgets.browser.runner.BrowserScriptRunner.JavaScriptExceptionListener} from the list of
	 * notified {@link de.fu_berlin.inf.ag_se.widgets.browser.runner.BrowserScriptRunner.JavaScriptExceptionListener}s.
	 * 
	 * @param javaScriptExceptionListener
	 */
