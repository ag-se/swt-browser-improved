...
public interface IAnchorListener {
	 ...
	 * {@link de.fu_berlin.inf.ag_se.widgets.browser.html.IElement}.
	 * 
	 * @param anchor instance of IAnchor
	 * @param entered
	 *            is true if the mouse entered the {@link de.fu_berlin.inf.ag_se.widgets.browser.html.IElement} and false if
	 *            the mouse left it.
	 */
