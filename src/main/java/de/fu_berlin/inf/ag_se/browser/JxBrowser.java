...
import de.fu_berlin.inf.ag_se.browser.jxbrowser.JxFrameworkBrowser;
...
public class JxBrowser implements IBrowser {

    private Browser browser;

    public JxBrowser(Container container) {
        this.browser = new Browser(new InternalBrowserWrapper(new JxFrameworkBrowser(container)));
    }
