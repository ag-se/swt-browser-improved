...
public class ImageUtils {
	...
	public static Image getDot(int width, int height,
			de.fu_berlin.inf.ag_se.utils.colors.RGB color,
			de.fu_berlin.inf.ag_se.utils.colors.RGB rgb) {
	...
	public static Image getDot(int width, int height,
			de.fu_berlin.inf.ag_se.utils.colors.RGB background,
			Float borderLightness) {
		de.fu_berlin.inf.ag_se.utils.colors.RGB border = borderLightness != null ? ColorUtils
