...
public interface IJQueryBrowser extends IBrowser {
	 ...
	 * found with the given {@link com.bkahlert.nebula.widgets.browser.extended.ISelector}.
	 * 
	 * @param name
	 * @return
	 */
	 ...
	 * selector. Typically only focused elements can be triggered.
	 * <p>
	 * In contrast to {@link #keyPress(com.bkahlert.nebula.widgets.browser.extended.ISelector, String)} this method call also
