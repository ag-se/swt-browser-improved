...
/**
 * Instances of this interface denote a {@link org.eclipse.swt.widgets.Composite} that is based on a
 * native {@link org.eclipse.swt.browser.Browser}.
 * 
 * @author bkahlert
 * 
 */
public interface IBrowser extends IBrowserScriptRunner, IWidget {
	 ...
	 * @param address
	 * @param timeout
	 *            after which the {@link com.bkahlert.nebula.widgets.browser.IBrowser} stops loading
	...
	/**
	 * Sets if {@link com.bkahlert.nebula.widgets.browser.IBrowser} may change its location by actions now invoked
	 ...
	 * {@link org.eclipse.swt.browser.Browser#setUrl(String)} method is called.
	 * 
	 * @param uri
	 */
	 ...
	 * {@link org.eclipse.swt.browser.Browser#setUrl(String)} method has been called.
	 * 
	 * @param uri
	 */
	...
	/**
	 * This method is called from the-UI thread after the {@link com.bkahlert.nebula.widgets.browser.IBrowser}
	 ...
	 * {@link com.bkahlert.nebula.widgets.browser.IBrowser} to finish loading and thus running its script queue.
	 * 
	 * @return
	 * @throws Exception
	 */
	...
	/**
	 * Returns a {@link java.util.concurrent.Future} that tells you if an element with the given id
	 * exists.
	 * 
	 * @param id
	 * @return
	...
	/**
	 * Returns a {@link java.util.concurrent.Future} that tells you if at least one element with the
	 * given name exists.
	 * 
	 * @param name
	 * @return
	...
	/**
	 * Adds a {@link com.bkahlert.nebula.widgets.browser.runner.BrowserScriptRunner.JavaScriptExceptionListener} that is notified if a
	 * exception is thrown in the {@link org.eclipse.swt.browser.Browser} by code that was not invoked
	...
	/**
	 * Removed the given {@link com.bkahlert.nebula.widgets.browser.runner.BrowserScriptRunner.JavaScriptExceptionListener} from the list of
	 * notified {@link com.bkahlert.nebula.widgets.browser.runner.BrowserScriptRunner.JavaScriptExceptionListener}s.
	 * 
	 * @param javaScriptExceptionListener
	 */
