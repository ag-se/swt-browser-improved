...
public class Browser extends Composite implements IBrowser {
	...
	/**
	 * Constructs a new {@link com.bkahlert.nebula.widgets.browser.Browser} with the given styles.
	 *
	 * @param parent
	 * @param style
	 *            if {@link org.eclipse.swt.SWT#INHERIT_FORCE}) is set the loaded page's
	...
	/**
	 * Injects the code needed for {@link #addAnkerListener(com.bkahlert.nebula.widgets.browser.listener.IAnkerListener)},
	 * {@link #addFokusListener(com.bkahlert.nebula.widgets.browser.listener.IFocusListener)} and
	 * {@link #addDNDListener(com.bkahlert.nebula.widgets.browser.listener.IFocusListener)} to work.
	 * <p>
	...
	/**
	 * This method waits for the {@link com.bkahlert.nebula.widgets.browser.Browser} to complete loading.
	 * <p>
	 * It has been observed that the
	 * {@link org.eclipse.swt.browser.ProgressListener#completed(org.eclipse.swt.browser.ProgressEvent)} fires to early. This
