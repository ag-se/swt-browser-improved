...
public class BrowserUtils {
	 ...
	 * for callback functions injected by {@link org.eclipse.swt.browser.BrowserFunction}.
	 *
	 * @return
	 */
	...
	/**
	 * This method creates an {@link com.bkahlert.nebula.widgets.browser.exception.JavaScriptException} out of the arguments
	 * passed by the {@link org.eclipse.swt.browser.Browser} to the callback specified using
	 ...
	 * <p>
	 * Passing the return value of {@link org.eclipse.swt.browser.Browser#evaluate(String)} to
	 * {@link #assertException(String, Object)} will raise an appropriate
	 * {@link com.bkahlert.nebula.widgets.browser.exception.JavaScriptException} if such one was thrown within the
	...
	/**
	 * Checks a the return value of {@link org.eclipse.swt.browser.Browser#evaluate(String)} for a
	 ...
	 * @param script
	 * @param returnValue
	 * @throws com.bkahlert.nebula.widgets.browser.exception.JavaScriptException
	 */
