 ...
 * by {@link org.eclipse.swt.widgets.Display} this util class allows also return values.
 * <p>
 ...
 * {@link java.util.concurrent.Future} instead of the value itself. Should the call have been made
 * from an UI thread the code must be executed in a separate thread.
 * <p>
 * Asynchronous non-UI thread naturally always returns a {@link java.util.concurrent.Future}.
 * <p>
 * To allow asynchronous non-UI thread methods to work with a custom
 * {@link java.util.concurrent.ExecutorService}, just instantiate {@link ExecUtils}. This is
...
public class ExecUtils {
	 ...
	 * {@link java.util.concurrent.Future} finished its computation.
	 *
	 * @UIThread must be called from the UI thread
	 * @param millis
	 */
	 ...
	 * has passed or the {@link java.util.concurrent.Future} finished its computation.
	 *
	...
	/**
	 * Waits until the given {@link java.util.concurrent.Callable} returns <code>false</code> in the
	 ...
	 * @param millis
	 * @throws Exception
	 *             thrown by the {@link java.util.concurrent.Callable}
	 */
	...
	/**
	 * Executes the given {@link java.util.concurrent.Callable} synchronously with a delay.
	 * <p>
	 * The return value is returned in the calling thread.
	 *
	...
	/**
	 * Runs the given {@link java.util.concurrent.Callable} with a delay in a non-UI thread. If the
	 * caller already runs in such one the {@link java.util.concurrent.Callable} is simply executed.
	 * Otherwise a new thread is started.
	 * <p>
	 * The given {@link Class} and purpose are used to give the thread a
	...
	/**
	 * Executes the given {@link java.util.concurrent.Callable} asynchronously, meaning always in a
	 * new thread.
	 *
	 * @param callable
	 * @return
	...
	/**
	 * Executes the given {@link java.util.concurrent.Callable}s asynchronously, meaning always in a
	 * new thread.
	 *
	 * @param callables
	 * @return
	...
	/**
	 * Executes the given {@link ExecUtils.ParametrizedCallable} once per
	 * element in the given input {@link java.util.Collection}.
	 * <p>
	 * In contrast to
	 * {@link #nonUIAsyncExec(java.util.concurrent.ExecutorService, java.util.Collection, ParametrizedCallable)}
	 * this method returns a single {@link java.util.concurrent.Future} containing all results.
	 *
	 * @param input
	 *            whose elements are used as the parameter for the
	 *            {@link ExecUtils.ParametrizedCallable}
